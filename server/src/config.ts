...
export class Config {
    debugLogging = 'debug';
    'server.port' = '8081';
    'jhipster.clientApp.name' = 'nestjsDemo';
    ...
    'jhipster.mail.from' = 'nestjsDemo@localhost';
    'jhipster.swagger.default-include-pattern' = '/api/.*';
    'jhipster.swagger.title' = 'nestjsDemo API';
    'jhipster.swagger.description' = 'nestjsDemo API documentation';
    ...
    'eureka.instance.appname' = 'nestjsDemo';
    'eureka.instance.instanceId' = 'nestjsDemo:${random.value}';
